 ...
 */
export function buildKeywordRegex(keywordsInput) {
 ...
 */
export function categorize(commits, pattern) {
    return (commits
        .split('\n')
...
export async function generateChangelog() {
    ...
    const changelog = [
        ...
        [
            '### Patch/Bug Fixes',
            buildKeywordRegex(getInputOrDefault('patch_keywords', 'patch,bug-fix,bug fix'))
        ],
        [
            '### Hotfixes',
