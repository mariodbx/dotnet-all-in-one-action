...
if (pullRepo) {
    ...
    console.log(`Cloned repository ${process.env.GITHUB_REPOSITORY} to ${process.env.GITHUB_WORKSPACE}`);
    ...
    console.log(`Pulled latest changes from branch/tag ${process.env.GITHUB_REF_NAME}`);
}
